...
**Echarts 官方网址，**[**参考这里**](https://echarts.apache.org/zh/index.html)**。**
# 基本图表使用场景

1. 柱状图：呈现每一种 **分类的数据**。
2. 折线图：数据随事件 **变化趋势**。
3. 散点图：推断出不同维度数据之间的 **相关性**。
4. 饼图：不同分类的 **占比情况**。
5. 地图：不同 **地理位置 **上的数据差异。
6. 雷达图：分析 **多个维度 **的数据与标准数据的对比情况。
7. 仪表盘：某个指标的 **进度 **情况。
# 配置项介绍
**Echarts 详细配置项，**[**参考这里**](https://echarts.apache.org/zh/option.html)**。**
**Echarts 常见图表配置，**[**参考这里**](https://github.com/VfanLee/code-notes/echarts-demo)**。**
**Echarts 官方图标示例，**[**参考这里**](https://echarts.apache.org/examples/zh/index.html)
# Echarts 显示相关
## Echarts 主题配置
